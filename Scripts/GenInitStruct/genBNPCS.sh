...
declare -a ELEMENT_ARR=('Co' 'Au')
declare -a MASS_ARR=(58.933 196.97)
declare -a RADIUS_ARR=(1.25 1.44)
declare -a FCC_LC_ARR=(3.537 4.09)
declare -a SIZE_ARR=(20 50)
declare -a SHAPE_ARR=('OT')
